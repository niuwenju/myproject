...
urlpatterns = [
    ...
    url(r'^p/(?P<_page_index>\d+)/$',tmitter.mvc.views.index_page,name="'tmitter.mvc.views.index_page'"),
...
#    url(r'^user/(?P<_username>[a-zA-Z\-_\d]+)/$',tmitter.mvc.views.index_user, name= "tmitter-mvc-views-index_user"),
    url(r'^user/(?P<_username>[a-zA-Z\-_\d]+)/$',tmitter.mvc.views.index_user, name= "tmitter-mvc-views-index_user"),
    url(r'^user/(?P<_username>[a-zA-Z\-_\d]+)/(?P<_page_index>\d+)/$',tmitter.mvc.views.index_user_page,name="'tmitter.mvc.views.index_user_page'"),
    url(r'^users/$',tmitter.mvc.views.users_index),
    url(r'^users/(?P<_page_index>\d+)/$',tmitter.mvc.views.users_list,name= "tmitter.mvc.views.users_list"),
